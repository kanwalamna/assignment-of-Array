...
//method.
console.log("\t \t Answer number 5 \n");
var fruits_name = ["Orange", "Gave", "Cherry", "Pineapple"];
...
console.log("\t \t Answer number 6 \n");
var new_fruits = ["Orange", "Mango", "Apple", "Cherry"];
...
//using the method.
console.log("\t \t Answer number 8 \n");
var fruits00 = ["Rusberry", "strawberry", "Orange"];
fruits00.unshift("Kiwi");
console.log(fruits00);
Question: 9;
//Remove 2 elements from the fruits array starting from index 1 
//using the method.
console.log("\t \t Answer number 9 \n");
var fruits0 = ["Orange", "Pinaple", "Graps", "Apple"];
fruits0.splice(1, 2);
console.log(fruits0);
Question: 10;
//Insert the elements "pineapple" and "pear" at index 2 of the 
//fruits array using the method.
console.log("\t \t Answer number 10 \n");
var fruits01 = ["Berry", "Graps", "Mango",];
...
console.log("\t \t Answer number 11 \n");
var fruits_list1 = ["Mango", "strawberry", "Berry"];
var citrusFruits = fruits_list1.slice(0, 2);
console.log(citrusFruits);
Question: 12;
//Create a new array named lastTwoFruits that contains the last 
//two elements of the fruits array using the  method.
console.log("\t \t Answer number 12 \n");
var fruitList3 = ["Banama", "Apple", "cherry", "Orange"];
